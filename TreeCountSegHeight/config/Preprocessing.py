...
#         self.training_base_dir = './example_preprocessing_data/'
...
#         self.raw_image_base_dir = 'example_preprocessing_data/'  # dir containing optical images (color bands)
...
#         self.path_to_write = './example_preprocessing_data/extracted_data/'
